...
return [
    'bad'                  => 'Щось пішло не так! Оновіть сторінку та спробуйте ще раз.',
    ...
    'attributes' => [
        ...
        'fields' => [
            'issuance_point_id'     => 'Точка видачі',
            'address'               => 'Адреса',
            'age'                   => 'Вік',
            'available'             => 'Доступно',
            'city'                  => 'Місто',
            ...
            'message'               => 'Повідомлення',
            'active'                =>'Активно',
            'korzina_key'           => 'API ключ для корзини',
            'korzina_id'            => 'Назва (ID) закладу у корзині',
            'price'                 => 'Ціна',
            'weight'                => 'Вага',
            'category_id'           => 'Категорія',
            'uk' => [
        ...
        'changes' => [
            ...
            'active'        =>'Активно',
            'price' => 'Ціна',
            'active_from' => 'Активно з',
            'price_date' => 'Змінити'
        ],

        'application' => [
            'vacancy_id' => 'Найменування вакансії',
            'name' => 'Ім\'я',
            'age' => 'Вік',
            'residence' => 'Місце проживання',
            'phone' => 'Телефон',
            'email' => 'E-mail',
            'salary' => 'Очікувана заробітна платня',
            'education_id' => 'Освіта',
            'experience_id' => 'Досвід роботи по спеціальності',
